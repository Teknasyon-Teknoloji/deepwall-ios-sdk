...
- (void)updateUserPropertiesDebugAdvertiseAttributions:(NSArray<NSString *> *)debugAdvertiseAttributions NS_SWIFT_NAME(updateUserProperties(debugAdvertiseAttributions:));

/// Update user properties
- (void)updateUserPropertiesCountry:(nullable DeepWallCountry *)country language:(nullable DeepWallLanguage *)language environmentStyle:(DeepWallEnvironmentStyle)environmentStyle debugAdvertiseAttributions:(nullable NSArray<NSString *> *)debugAdvertiseAttributions  NS_SWIFT_NAME(updateUserProperties(country:language:environmentStyle:debugAdvertiseAttributions:));
