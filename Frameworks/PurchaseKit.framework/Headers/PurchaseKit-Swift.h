...
/// TODO: Documentation
SWIFT_CLASS("_TtC11PurchaseKit11PurchaseKit")
...
@interface PurchaseKit (SWIFT_EXTENSION(PurchaseKit)) <SKProductsRequestDelegate>
...
@interface PurchaseKit (SWIFT_EXTENSION(PurchaseKit)) <SKPaymentTransactionObserver>
